/*
 * SoftBreak — обединен скрипт (без ES модули).
 ...
 *
 * Оригиналните модули в тази папка (index.js, utils.js, time.js, ...) са запазени
 * за справка, но НЕ се зареждат — index.html ползва само този файл.
 */
(function () {
    'use strict';
     ...
     *    локално през file:// понякога не тръгва — браузърна ограничение).
